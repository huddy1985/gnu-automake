...
%
\def\texinfoversion{2003-12-08.17}
%
...
% Environments start with this:
\def\startenvironment#1{\begingroup\def\thisenv{#1}}
% initialize
\let\thisenv\empty

% ... but they get define via ``\envdef\foo{...}'':
...
%
\envdef\enumerate{\parsearg\enumeratex}
\def\enumeratex#1{\enumeratey #1  \endenumeratey}
...
% @iftex, @ifnothtml, @ifnotinfo, @ifnotplaintext always succeed.
% They currently do nothing; it doesn't attempt to check whether
% the conditionals are properly nested.
% But we have to remember that they are conditionals, so that @end
% doesn't attempt to close environment group.
%
\def\makecond#1{%
